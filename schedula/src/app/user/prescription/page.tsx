// this page displays all the prescriptions for a patient, and on clicking the prescription will route to prescription/[id] page
  ...
  useEffect(() => {
    const fetchPrescriptions = async () => {
      ...
      try {
        ...
        console.log("all prescriptions: ", prescriptionsResult);
