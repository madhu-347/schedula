...
export default function AppointmentDetailPage() {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      {/* Header */}
      <header className="bg-cyan-500 text-white pt-6 pb-5">
      ...
      <div className="fixed bottom-20 left-0 right-0 z-30 pointer-events-none">
        <div className="max-w-3xl mx-auto px-5">
          <button className="pointer-events-auto w-full bg-cyan-500 hover:bg-cyan-600 text-white font-semibold py-3.5 rounded-xl shadow-lg cursor-pointer">
            Book appointment
          </button>
        </div>
      </div>
